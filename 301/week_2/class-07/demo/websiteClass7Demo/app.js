...
$('form:first-of-type').on('submit', (event) => {
  ...
  //go out to jquery to find insert after. 
...
$('form:nth-of-type(2)').on('submit', event => {
  ...
  //step 2: gps data is returned from the server
    .then(stuffThatComesBack => {
      ...
      //lets look at the long way of doing this. 
      $.ajax(
...
// we will have two ajax calls alivend by the end of the week there will be four.
