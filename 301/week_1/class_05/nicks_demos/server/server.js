...
// /doggo is called a route then it take in a call back function the difference is on the front end its taking in an event and this is taking in a req and res same thing from the wRRc
