...
- Float-based layout should also be a review for those students who have completed Code 201.
...
- **Why** (5 min)
  - $ = jquery.    like jquery.ajax or $.ajax. 
    - Simple syntax
             is a easier way to access all the stuff. 
...
- **Experimentation and Discovery Ideas**
  - Refactor between Vanilla and jQuery to get students correlating Show the vanilla JavaScript way to manipulate   elements and traverse the DOM, then demonstrate how to accomplish the same thing with jQuery.
