...
Each team member's grade is based on their individual effort and the project's
technical merit.

Individual effort is graded based on links to commits and Pull Requests that
demonstrate your contributions, as submitted in Canvas in the daily project reports.
...
- Good and proper use of React
    ...
    - Correctly passes props, identifying both shared state and behaviors (methods)
     to child components
...
- Good and proper use of JavaScript and
    ...
    - Uses React to respond to user events, receive and process user input, and display
