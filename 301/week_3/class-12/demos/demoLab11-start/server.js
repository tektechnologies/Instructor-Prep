...
//tell express to load ejs this unlocks the response render

app.use(express.static(__dirname + '/public'));
//this gives us permission to read these files. Targets any files in the public folder.

app.use(express.urlencoded({extended: true}));
//read the encoded url data and puts it in the req.body.
...
//This route is tied to our form   action="/searches" method="POST"
...
function makeASearch(req, res){
  ...
  superagent.get(url)
    .then(result => {
      ...
      console.log('resullltwwwwwwwwwww ', result.body.items[0].volumeInfo);
      ...
      res.render('search-result.ejs', {books: books});
    });
}
